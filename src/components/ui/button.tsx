  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-card-border bg-card/50 backdrop-blur-sm text-foreground hover:bg-card hover:shadow-glow-primary/50",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        gradient: "bg-gradient-primary text-primary-foreground hover:shadow-glow-accent transform hover:scale-105",
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-glow-primary transform hover:scale-105 font-semibold",
        glass: "glass-card text-foreground hover:shadow-glow-accent glow-on-hover border-card-border/50",
      },
      size: {
